...
class LoginDialog(QDialog):
    ...
    def create_login_area(self):
        ...
        self.login_btn.setStyleSheet("QPushButton { background-color: #0078d4; color: white; border: none; border-radius: 6px; font-size: 14px; font-weight: bold; } QPushButton:hover { background-color: #106ebe; } QPushButton:pressed { background-color: #005a9e; }")
        self.login_btn.clicked.connect(self.handle_login)
        layout.addWidget(self.login_btn)
        
        hint_label = QLabel("默认账号: admin/admin123, doctor/doctor123, tech/tech123")
        hint_label.setStyleSheet("QLabel { color: #999; font-size: 11px; text-align: center; }")
